...
public class CvbsActivity extends AppCompatActivity{
    ...
    private ImageButton mFillLightBtn= null;
    ...
    private void init() {
        ...
        mRecordSettingsBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (isRecording) {
                    new AlertDialog.Builder(CvbsActivity.this, android.R.style.Theme_Material_Dialog_Alert)
                            .setTitle("进入设置会停止录像")
        ...
        mFillLightBtn.setOnClickListener(new View.OnClickListener() {
        ...
        mBackBtn.setOnClickListener(new View.OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				startActivity(new Intent(CvbsActivity.this, MainActivity.class));
			}
		});
                            ...
                            .subscribe(new Consumer<Long>() {
                                ...
                                public void accept(Long time) throws Exception {
                                    ...
                                    if (time != 0L && time%duration == 0L) {
                                        ...
                                        Toast.makeText(CvbsActivity.this, "录制下一个视频",
...
//                            });
        ...
        mRecordLockBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!isRecording) {
                    // 如果不处于录制状态，则不做任何处理
                    Toast.makeText(CvbsActivity.this, "不在录制状态", Toast.LENGTH_SHORT).show();
                    return;
                }
                isLocked = !isLocked;
                ...
                if (isLocked) {
                    // 锁定
                    Toast.makeText(CvbsActivity.this, "锁定", Toast.LENGTH_SHORT).show();
                    mRecordLockBtn.setImageResource(R.drawable.ic_lock_outline_red_a400_48dp);
                } else {
                    // 解锁
                    Toast.makeText(CvbsActivity.this, "解锁", Toast.LENGTH_SHORT).show();
    ...
    private void createFloatingView() {
        ...
        //获取浮动窗口视图所在布局
        mFloatLayout = (LinearLayout) inflater.inflate(R.layout.cvbs_float_layout, null);
        //添加mFloatLayout
        ...
        //新增加补光和返回按钮
        mFillLightBtn= (ImageButton) mFloatLayout.findViewById(R.id.fill_light_btn);
